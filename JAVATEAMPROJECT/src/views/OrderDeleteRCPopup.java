...
public class OrderDeleteRCPopup extends JDialog implements ActionListener {
    public static final int width = 300, height = 300;

    public OrderDeleteRCPopup(DefaultFrame prt) {
        super(prt, "", true);
        ...
        JLabel message = new JLabel("취소가 완료되었습니다.");
